...
print('NUMBER =', numFun)
print('SALARY = U$ {:.2f}'.format(salFun))

"""
A diferença é que no texto é comentado apenas o $ mas no exemplo de saída ha um U antes
dele, ou seja a saída tem de ser igual a do exemplo com a condição do texto
"""
