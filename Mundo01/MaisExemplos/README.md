...
Exercícios complementares em Python para reforço de lógica de programação.

##

## Sobre

Este diretório reúne exercícios adicionais e exemplos práticos desenvolvidos como complemento aos estudos principais, com foco em fixação de lógica, operações matemáticas, estruturas condicionais e repetição.
